...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.Holder> {
     ...
     */
    public RecyclerAdapter(@Nullable Object enclosing) {
    ...
    public abstract static class Holder<T> extends RecyclerView.ViewHolder {
         ...
         */
        protected void onBindData(int position, T data, @NonNull List<Object> payloads) {
         ...
         * @see RecyclerView.Adapter#onBindViewHolder(RecyclerView.ViewHolder, int, List)
         */
        protected void onBindData(int position, T data, @Nullable Object payload) {
        }
